...
//Algorithm for calculating th ai, moves
public final class MinMax implements MoveStrategy 
{
    ...
    {
        this.evaluator = StandardBoardEval.get();
    ...
    private static class FreqTableRow
    {
        ...
        public String toString()
        {
            return BoardUtils.INSTANCE.getPositionAtCoordinate(this.move.getCurrentCoordinates()) +
                   BoardUtils.INSTANCE.getPositionAtCoordinate(this.move.getDesCoordinates()) + " : " +this.count;
        }
    }
}
