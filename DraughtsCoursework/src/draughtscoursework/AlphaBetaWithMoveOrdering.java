...
public class AlphaBetaWithMoveOrdering extends Observable implements MoveStrategy 
{
    ...
    private enum MoveSorter 
    {
        ...
        public static Comparator<Move> SMART_SORT = new Comparator<Move>() 
        {
            ...
            {
                return ComparisonChain.start() .compareTrueFirst(move1.isAttack(), move2.isAttack()).compare(move2.getMovedPiece().getPieceValue(), move1.getMovedPiece().getPieceValue()).result();
            }
        };
