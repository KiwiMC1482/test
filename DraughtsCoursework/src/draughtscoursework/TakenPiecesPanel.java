...
//Shows what pieceshave beentaken throughout the game
class TakenPiecesPanel extends JPanel 
{
    ...
    public void redo(final MoveLog moveLog) 
    {
        ...
        //Gets the icons for the taken pieces and rescales them to be puton the panel
        for (final Piece takenPiece : whiteTakenPieces) 
        {
            if(takenPiece.getPieceType().isKing())
            {
                //White King
                try
                {
                 ...
                 final ImageIcon ic = new ImageIcon(whiteKingImage);
            ...
            else
            {
                ...
                try
                {
                 ...
                 final ImageIcon ic = new ImageIcon(whiteCheckerImage);
                 final JLabel imageLabel = new JLabel(new ImageIcon(ic.getImage().getScaledInstance(
                 ic.getIconWidth() - 15, ic.getIconWidth() - 15, Image.SCALE_SMOOTH)));
                    this.southPanel.add(imageLabel);
                }
        ...
        for (final Piece takenPiece : blackTakenPieces) 
        {
            ...
            if(takenPiece.getPieceType().isKing())
            {
                try
                {
                 ...
                 final ImageIcon ic = new ImageIcon(blackKingImage);
                 final JLabel imageLabel = new JLabel(new ImageIcon(ic.getImage().getScaledInstance(
                 ic.getIconWidth() - 15, ic.getIconWidth() - 15, Image.SCALE_SMOOTH)));
                 this.southPanel.add(imageLabel);
                }
            ...
            else
            {
                try
                {
                 ...
                 final ImageIcon ic = new ImageIcon(blackCheckerImage);
                 final JLabel imageLabel = new JLabel(new ImageIcon(ic.getImage().getScaledInstance(
                 ic.getIconWidth() - 15, ic.getIconWidth() - 15, Image.SCALE_SMOOTH)));
                 this.southPanel.add(imageLabel);
                }
